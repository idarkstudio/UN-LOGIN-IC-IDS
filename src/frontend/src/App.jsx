...
import ROMUniverse from './components/ROMUniverse';
import Token from './components/Token';
import Roadmap from './components/Roadmap';
import LatinAmerica from './components/LatinAmerica';
...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Latin America\'s premier Web3 game studio creating fully on-chain gaming experiences',
    'hero.cta': 'Explore the Universe',
    
    // About
    'about.title': 'About Inside Dark Studio',
    'about.description': 'We are a Latin American game studio pioneering the future of Web3 gaming with fully on-chain games and decentralized infrastructure.',
    ...
    'aboutus.team.description': 'A powerhouse collective of 30 visionary minds, combining the rigorous analytical depth of academic professors with the battle-tested expertise of industry veterans from Warner, Blizzard, Bandai Namco, Nway, and Roblox. This unique fusion creates an unparalleled force in Web3 gaming development.',
    'aboutus.leadership.title': 'Leadership Team',
    'aboutus.vision.title': 'Our Vision',
    'aboutus.vision.description': 'We don\'t just build games—we architect digital universes. Our approach merges scholarly precision with creative audacity, establishing new paradigms in decentralized gaming that will define the industry\'s future.',
    'aboutus.expertise.title': 'Expertise & Innovation',
    'aboutus.expertise.description': 'Our multidisciplinary approach combines cutting-edge research methodologies with proven industry practices, creating solutions that are both theoretically sound and commercially viable.',
    ...
    // Latin America
    'latam.title': 'Why Latin America?',
    'latam.subtitle': 'The fastest-growing gaming market in the world',
    
    // Technology
    'tech.title': 'Technology Stack',
    'tech.subtitle': 'Cutting-edge infrastructure',
  ...
  es: {
    ...
    'hero.subtitle': 'El estudio de juegos Web3 líder de América Latina creando experiencias de juego completamente on-chain',
    'hero.cta': 'Explorar el Universo',
    
    // About
    'about.title': 'Acerca de Inside Dark Studio',
    'about.description': 'Somos un estudio de juegos latinoamericano pionero en el futuro de los juegos Web3 con juegos completamente on-chain e infraestructura descentralizada.',
    ...
    'aboutus.team.description': 'Un colectivo poderoso de 30 mentes visionarias, combinando la profundidad analítica rigurosa de profesores académicos con la experiencia probada en batalla de veteranos de la industria de Warner, Blizzard, Bandai Namco, Nway y Roblox. Esta fusión única crea una fuerza sin paralelo en el desarrollo de juegos Web3.',
    'aboutus.leadership.title': 'Equipo de Liderazgo',
    'aboutus.vision.title': 'Nuestra Visión',
    'aboutus.vision.description': 'No solo construimos juegos—arquitectamos universos digitales. Nuestro enfoque fusiona la precisión académica con la audacia creativa, estableciendo nuevos paradigmas en juegos descentralizados que definirán el futuro de la industria.',
    'aboutus.expertise.title': 'Experiencia e Innovación',
    'aboutus.expertise.description': 'Nuestro enfoque multidisciplinario combina metodologías de investigación de vanguardia con prácticas industriales probadas, creando soluciones que son tanto teóricamente sólidas como comercialmente viables.',
    ...
    // Latin America
    'latam.title': '¿Por qué América Latina?',
    'latam.subtitle': 'El mercado de juegos de más rápido crecimiento en el mundo',
    
    // Technology
    'tech.title': 'Stack Tecnológico',
    'tech.subtitle': 'Infraestructura de vanguardia',
...
function App() {
  ...
  useEffect(() => {
    const savedLanguage = localStorage.getItem('ids-language') as Language;
