...
const Navigation = () => {
  ...
  const handleDarkPitchClick = () => {
    window.open(
      "https://www.canva.com/design/DAGt52im6fM/sjc3Y_mm5hE6XF4o-67Cdg/view?utm_content=DAGt52im6fM&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=hdf120cf1f4",
      "_blank",
      "noopener,noreferrer"
    );
  };
