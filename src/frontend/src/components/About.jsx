      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative group h-full">
            <div className="relative overflow-hidden rounded-2xl border border-red-900 hover:border-red-500 transition-all duration-300 h-full">
              <img
                src="/images/darkirina.png"
                alt="Inside Dark Studio"
                className="w-full object-cover group-hover:scale-105 transition-transform duration-300 h-full"
              />
