...
import { ArrowLeft, Users, Award, Lightbulb, Target, ChevronRight } from 'lucide-react';
  ...
  const leadershipTeam = [
    {
      name: 'Mariano Stoll',
      role: 'CEO',
      description: 'Visionary leader with extensive experience in Web3 gaming and blockchain technology',
            ...
            <div>
              ...
              <div className="bg-gradient-to-r from-red-900/20 to-red-800/20 backdrop-blur-sm rounded-xl p-6 border border-red-700">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {['Warner', 'Blizzard', 'Bandai Namco', 'Nway', 'Roblox', 'Academia'].map((company, index) => (
                    <div key={index} className="text-center p-3 bg-black/50 rounded-lg border border-red-900">
              ...
              <div className="bg-gradient-to-r from-red-900/20 to-red-800/20 backdrop-blur-sm rounded-xl p-8 border border-red-700">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-300">Pioneering fully decentralized gaming ecosystems</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-gray-300">Empowering players with true digital ownership</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-gray-300">Establishing Latin America as a Web3 gaming hub</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-r from-red-900/20 to-red-800/20 backdrop-blur-sm rounded-2xl p-12 border border-red-700">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Be part of the team that's redefining the future of gaming. 
