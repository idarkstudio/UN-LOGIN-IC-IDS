...
import { Coins, TrendingUp, Gift, Gamepad2, Crown, Shield, Zap, Star, Users, Calendar, MapPin, Percent } from 'lucide-react';
...
const Token: React.FC = () => {
  ...
  const rarityPerks = [
    ...
    },
    {
      ...
      details: 'Monthly Ancient Gold delivery that grows 10% each month, stackable for multiple NFT holders',
    },
    {
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">
              666 hand-finished NFTs, each representing a unique part of the ROM Universe. 
              Designed for OG supporters and featuring iconic early concept art from our development journey.
            </p>
          </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0" />
                      <span className="text-gray-300">Primary in-game currency across ROM Universe</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0" />
                      <span className="text-gray-300">Tradeable for ICP on supported exchanges</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0" />
                      <span className="text-gray-300">Used for purchases, upgrades, and premium content</span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {factions.map((faction, index) => (
                ...
                >
                  ...
                  <h5 className={`text-xl font-bold mb-3 bg-gradient-to-r ${faction.color} bg-clip-text text-transparent`}>
                    {faction.name}
                  </h5>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-red-900/20 to-red-800/20 backdrop-blur-sm rounded-2xl p-8 border border-red-700">
              <h4 className="text-2xl font-bold mb-4 text-red-500">
                For the OG Community
              </h4>
              <p className="text-gray-300 mb-6 max-w-3xl mx-auto">
                The Genesis Collection is crafted specifically for our original supporters who believed in our vision from the beginning. 
                Launching alongside our Alpha release, these NFTs feature iconic early concept art that captures the raw creative energy 
                of Inside Dark Studio's journey into the ROM Universe.
              </p>
