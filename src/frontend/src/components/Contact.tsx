...
import { Mail, MessageCircle, Send, ExternalLink, CheckCircle, AlertCircle } from 'lucide-react';
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-red-900/20 to-red-800/20 backdrop-blur-sm rounded-2xl p-8 border border-red-700">
              ...
              <p className="text-gray-300 mb-6">
                Be part of the revolution in Web3 gaming. Connect with developers, players, and enthusiasts 
