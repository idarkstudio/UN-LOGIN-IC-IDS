...
import { Zap, Code, Layers, Gamepad2, ArrowRight } from 'lucide-react';
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-red-900/20 to-red-800/20 backdrop-blur-sm rounded-xl p-6 border border-red-700">
              ...
              <p className="text-gray-300 text-sm">
                To revolutionize the gaming industry by creating truly decentralized, 
                player-owned gaming experiences that empower communities and foster innovation 
                across Latin America's vibrant gaming ecosystem.
              </p>
            </div>
          </div>
        </div>
